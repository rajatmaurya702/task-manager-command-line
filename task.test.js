...
var local_dirname  = "C:/Users/Rajat^ Maurya/Downloads/fellowship-javascript/javascript"
let deleteFile = (path) => {
  ...
  beforeEach(() => {
    deleteFile(`${local_dirname}/task.txt`);
    deleteFile(`${local_dirname}/completed.txt`);
  })
};

// let tasksTxtCli = (...args) => [`${__dirname}/task.sh`, ...args].join(" ");
let tasksTxtCli = (...args) => [`${local_dirname}/task.sh`, ...args].join(" ");
// C:\Users\Rajat Maurya\Downloads\fellowship-javascript\javascript\task.sh
